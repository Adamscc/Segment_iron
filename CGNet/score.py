...
if __name__ == "__main__":
    # 训练好的模型的路径
    model_path = "../base_unet/checkpoints/CGNet_train1/CGNet_20_train1.pt"
    ...
    #### 计算 Class IoU 分数 ####
    pred_dir = r'D:\AILAB\校园算法\挑战赛\赛题2-钢材表面缺陷检测与分割\Seg（分割赛题记分）\test_predictions'
    base_dir = r'D:\AILAB\校园算法\挑战赛\赛题2-钢材表面缺陷检测与分割\Seg（分割赛题记分）\baseline_predictions'
    gt_dir = r'D:\AILAB\校园算法\挑战赛\赛题2-钢材表面缺陷检测与分割\Seg（分割赛题记分）\test_ground_truths'
    num_classes = 3  # 异常类型数
